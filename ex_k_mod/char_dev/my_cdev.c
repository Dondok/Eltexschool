/*
 * при чтении из устройства с соответствующим мажорным и минорным номером
 * выдает сообщение с количеством обращений к устройству.
 */
...
static int device_open(struct inode *inode, struct file *file)
{
	...
	if (Device_Open){
		return -EBUSY; // EBUSY - означает, что мажорный номер занят
	}
	Device_Open++;
...
device_write(struct file *filp, const char *buff, size_t len, loff_t * off)
{
	...
	return -EINVAL; // EINVAL- означает, что указанное число недопустимо
}
